...
export const BIOMES: BiomeDef[] = [
  {
    ...
    sediment: 0.92, rockColor: c(0xbfae8e), rippleScale: 1.25, regionWeight: 1.4,
  },
  {
    ...
    sediment: 0.66, rockColor: c(0x8a8567), rippleScale: 0.8, regionWeight: 1.2,
  },
  {
    ...
    sediment: 0.78, rockColor: c(0x7d8266), rippleScale: 0.9, regionWeight: 1.15,
  },
  {
    ...
    sediment: 0.46, rockColor: c(0x8d6350), rippleScale: 0.6, regionWeight: 1.0,
  },
  {
    ...
    sediment: 0.6, rockColor: c(0x685d70), rippleScale: 0.55, regionWeight: 0.95,
  },
  {
    ...
    sediment: 0.72, rockColor: c(0x4b333a), rippleScale: 0.4, regionWeight: 1.0,
  },
  {
    ...
    sediment: 0.5, rockColor: c(0x415050), rippleScale: 0.3, regionWeight: 0.9,
  },
  {
    ...
    sediment: 0.22, rockColor: c(0x2e1d1a), rippleScale: 0.2, regionWeight: 0.8,
  },

  /* ---- new regions ------------------------------------------------------ */
  {
    id: 'coral_reef', name: 'Coral Reef Wall', depthRange: [18, 130],
    floorColor: c(0xcf9f79), fogColor: c(0x24b0c4), fogDensity: 0.018, ambientLight: 0.9,
    ...
    sediment: 0.3, rockColor: c(0xc2a382), rippleScale: 0.5, regionWeight: 1.25,
  },
  {
    id: 'sand_dunes', name: 'Sand Dunes', depthRange: [110, 330],
    floorColor: c(0xc3b391), fogColor: c(0x137384), fogDensity: 0.03, ambientLight: 0.52,
    flora: [{ id: 'seagrass', density: 0.35 }],
    fauna: [{ id: 'sandshark', density: 0.35 }, { id: 'jellyray', density: 0.2 }], music: 'plateau',
    sediment: 1.0, rockColor: c(0xb0a184), rippleScale: 1.6, regionWeight: 1.2,
  },
  {
    id: 'boulder_garden', name: 'Boulder Garden', depthRange: [55, 210],
    floorColor: c(0x8a8878), fogColor: c(0x157584), fogDensity: 0.029, ambientLight: 0.58,
    ...
    sediment: 0.35, rockColor: c(0x7c7b6e), rippleScale: 0.45, regionWeight: 1.05,
  },
  {
    id: 'crag_field', name: 'Crag Field', depthRange: [170, 430],
    floorColor: c(0x5a5f68), fogColor: c(0x0f4d5c), fogDensity: 0.042, ambientLight: 0.3,
    flora: [{ id: 'bioluminescent', density: 0.7 }],
    fauna: [{ id: 'bladderfish', density: 0.4 }], music: 'mushroom',
    sediment: 0.18, rockColor: c(0x545a63), rippleScale: 0.25, regionWeight: 1.0,
  },
  {
    id: 'deep_basin', name: 'Deep Sediment Basin', depthRange: [300, 620],
    floorColor: c(0x5e5b52), fogColor: c(0x0d2f3a), fogDensity: 0.05, ambientLight: 0.2,
    flora: [{ id: 'bioluminescent', density: 0.9 }],
    fauna: [{ id: 'ghostray', density: 0.1 }, { id: 'bladderfish', density: 0.35 }], music: 'bloodkelp',
    sediment: 1.0, rockColor: c(0x585449), rippleScale: 1.1, regionWeight: 1.1,
  },
];
