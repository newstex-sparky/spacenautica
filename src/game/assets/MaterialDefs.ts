...
const DEFS: Record<string, MaterialDef> = {
  ...
  sand_fine: {
    ...
    macro: [3, 3, 0.34, 0.55], mid: [16, 16, 0.09, 0], micro: [160, 160, 0.011, 0.055],
  ...
  sand_rippled: {
    ...
    macro: [3, 3, 0.26, 0.55], mid: [14, 14, 0.075, 0], micro: [160, 160, 0.011, 0.06],
  ...
  gravel: {
    ...
    macro: [3, 3, 0.2, 0.5], mid: [18, 18, 0.24, 0], micro: [150, 150, 0.012, 0.05],
  ...
  mud_silt: {
    ...
    macro: [3, 3, 0.2, 0.6], mid: [12, 12, 0.075, 0], micro: [150, 150, 0.009, 0.01],
  ...
  clay_red: {
    ...
    macro: [3, 3, 0.22, 0.6], mid: [10, 10, 0.11, 0], micro: [150, 150, 0.009, 0.02],
  ...
  rock_basalt: {
    family: 'rock', sub: 0,
    macro: [3, 3, 0.3, 0.6], mid: [9, 9, 0.14, 0], micro: [140, 140, 0.012, 0.04],
  ...
  rock_limestone: {
    family: 'rock', sub: 1,
    macro: [3, 3, 0.3, 0.65], mid: [11, 11, 0.16, 0], micro: [140, 140, 0.011, 0.05],
  ...
  rock_sandstone: {
    family: 'rock', sub: 2,
    macro: [3, 3, 0.28, 0.6], mid: [10, 10, 0.13, 0], micro: [150, 150, 0.011, 0.06],
  ...
  shale_dark: {
    family: 'rock', sub: 3,
    macro: [3, 3, 0.26, 0.55], mid: [12, 12, 0.12, 0], micro: [150, 150, 0.01, 0.05],
  ...
  crystal_face: {
    family: 'rock', sub: 4,
    macro: [3, 3, 0.1, 0.4], mid: [7, 7, 0.07, 0], micro: [130, 130, 0.008, 0.12],
  ...
  coral_brain: {
    ...
    macro: [3, 3, 0.16, 0.7], mid: [1, 1, 0.3, 0], micro: [130, 130, 0.012, 0.06],
  ...
  coral_tube: {
    ...
    macro: [3, 3, 0.14, 0.6], mid: [1, 1, 0.28, 0], micro: [120, 120, 0.011, 0.05],
  ...
  coral_fan: {
    ...
    macro: [3, 3, 0.1, 0.6], mid: [1, 1, 0.22, 0], micro: [120, 120, 0.01, 0.05],
  ...
  kelp_blade: {
    ...
    macro: [2, 2, 0.1, 0.5], mid: [1, 6, 0.12, 0], micro: [90, 130, 0.012, 0.04],
  ...
  algae_mat: {
    ...
    macro: [4, 4, 0.14, 0.7], mid: [12, 12, 0.16, 0], micro: [110, 40, 0.014, 0.06],
  ...
  seagrass: {
    ...
    macro: [2, 2, 0.08, 0.4], mid: [1, 8, 0.09, 0], micro: [80, 140, 0.01, 0.03],
  ...
  sponge: {
    ...
    macro: [3, 3, 0.16, 0.7], mid: [1, 1, 0.3, 0], micro: [120, 120, 0.013, 0.04],
  ...
  bioluminescent: {
    ...
    macro: [3, 3, 0.12, 0.6], mid: [1, 1, 0.2, 0], micro: [120, 120, 0.011, 0.05],
  ...
  hull_painted: {
    ...
    macro: [3, 3, 0.06, 0.5], mid: [12, 12, 0.05, 0], micro: [150, 150, 0.009, 0.03],
  ...
  hull_rusted: {
    ...
    macro: [3, 3, 0.07, 0.5], mid: [12, 12, 0.06, 0], micro: [150, 150, 0.01, 0.03],
  ...
  metal_brushed: {
    ...
    macro: [3, 3, 0.03, 0.4], mid: [8, 8, 0.03, 0], micro: [120, 120, 0.006, 0.05],
  ...
  metal_scuffed: {
    ...
    macro: [3, 3, 0.05, 0.45], mid: [14, 14, 0.05, 0], micro: [130, 130, 0.008, 0.05],
  ...
  glass_scratched: {
    ...
    macro: [2, 2, 0.02, 0.3], mid: [10, 10, 0.02, 0], micro: [140, 140, 0.004, 0.02],
    a: [1, 1, 0, 0], b: [1, 1, 0, 0], c: [1, 1, 1, 0.5],
  ...
  rubber_seal: {
    ...
    macro: [3, 3, 0.03, 0.4], mid: [1, 18, 0.09, 0], micro: [110, 110, 0.012, 0.005],
  ...
  circuit_panel: {
    ...
    macro: [3, 3, 0.02, 0.3], mid: [12, 12, 0.02, 0], micro: [140, 140, 0.006, 0.02],
  ...
  fabric_suit: {
    ...
    macro: [3, 3, 0.02, 0.3], mid: [1, 1, 0.2, 0], micro: [150, 150, 0.008, 0.01],
  ...
  plastic_orange: {
    ...
    macro: [3, 3, 0.03, 0.4], mid: [8, 8, 0.03, 0], micro: [120, 120, 0.007, 0.02],
  ...
  decal_warning: {
    ...
    macro: [3, 3, 0.03, 0.4], mid: [10, 10, 0.03, 0], micro: [150, 150, 0.008, 0.02],
  ...
  skin_scales: {
    family: 'skin', sub: 0,
    macro: [4, 2, 0.08, 0.5], mid: [1, 1, 0.1, 0], micro: [140, 140, 0.008, 0.04],
  ...
  skin_smooth: {
    family: 'skin', sub: 1,
    macro: [4, 2, 0.08, 0.5], mid: [1, 6, 0.07, 0], micro: [150, 150, 0.007, 0.02],
  ...
  skin_leathery: {
    family: 'skin', sub: 2,
    macro: [4, 2, 0.1, 0.55], mid: [1, 1, 0.12, 0], micro: [140, 140, 0.009, 0.03],
  ...
  detail_grunge: {
    ...
    macro: [4, 4, 0.2, 0.7], mid: [20, 20, 0.12, 0], micro: [150, 150, 0.012, 0.04],
    a: [1, 1, 0, 0], b: Z, c: Z,
  ...
  detail_noise: {
    ...
    macro: [4, 4, 0.1, 0.5], mid: [16, 16, 0.3, 0], micro: [128, 128, 0.01, 0],
    a: [1, 1, 0, 0], b: Z, c: Z,
  ...
  foam_mask: {
    ...
    macro: [4, 4, 0.12, 0.7], mid: [26, 26, 0.2, 0], micro: [140, 140, 0.01, 0.03],
    a: [1, 1, 0, 0], b: Z, c: Z,
  ...
  caustic_tile: {
    ...
    macro: [4, 4, 0.05, 0.4], mid: [10, 10, 0.05, 0], micro: [120, 120, 0.004, 0],
  ...
  wet_ripple: {
    ...
    macro: [4, 4, 0.06, 0.5], mid: [12, 12, 0.055, 0], micro: [130, 130, 0.008, 0.02],
    a: [7, 3, 0, 0], b: Z, c: Z,
